...
const FollowedCreatorSection = ({ data }) => {
	// embla ------------------------------
		...
		<Wrapper>
			<Container>
				<div className="top-content">
					<h2 className="title-main">Followed Creators</h2>
				...
				<div className="embla" ref={emblaRef}>
					<ItemContainer>
						{data.followed_creator.map((followedCreators, index) => (
							<FollowedCreatorCard key={`followed-creator${index}`} followedCreators={followedCreators} />
						))}
					</ItemContainer>
				</div>
			</Container>
...
export default FollowedCreatorSection;
